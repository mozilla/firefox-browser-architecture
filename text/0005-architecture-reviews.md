...
1. Lay the stage. The team should document (See "initial meeting" below):
  * Someone to **chair** the review (for a Roadmap Review this will be the *least* senior person in the management chain with the ability to provide resources to the problem, for a Design Review this will be the *most* experienced engineer outside of the team willing to put time into the problem. As engineers don’t review their own code they shouldn’t review their own designs)
...
2. The team produces a **Review Packet** designed to answer the question identified in step 1. The production of the Review Packet is expected to be collaborative and iterative to ensure that the review focuses on the key questions and the team presents its best case. This is particularly true of a Roadmap Review where the consequences of the answer are likely to be higher.
The Review Packet includes:
  * A lay summary of the problem space and the stakeholders which focused on defining a shared language and identifying the key forces behind the problem
  * A brief explaining what the team proposes which should read more like an encyclopedia entry than a marketing document.  The brief should identify:
    - the forces on the system
    - the proposed system’s essential architecture
    - scenarios that exercise the relevant forces against the architecture
    - how the proposed system handles these scenarios
...
In order to agree the question(s), the chair and the team/technical lead or principles will generally have an initial meeting. This meeting should be as small possible and is intended to:
...
* The "Roadmap" stage: the team has an idea, and wants broader buy-in to justify investment in the problem space.
